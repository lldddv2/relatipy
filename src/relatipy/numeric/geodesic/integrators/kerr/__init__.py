...
Fujita (explicit RK4 in Mino time)
...
>>> from relatipy.numeric.geodesic.integrators.kerr import _integrate_kerr_fujita
"""
...
from .fujita import _integrate_kerr_fujita
